...
public class ExtentReportNG {
	...
	public static ExtentReports setupExtentReport() throws Exception {
		...
		extent.setSystemInfo("Executed on Environment: ", PropertuFile.getPropertyByValue("url"));
		extent.setSystemInfo("Executed on Browser: ", PropertuFile.getPropertyByValue("browser"));
